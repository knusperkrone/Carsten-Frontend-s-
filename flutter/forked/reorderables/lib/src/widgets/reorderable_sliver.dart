...
typedef IsReorderableCallback = bool Function(Widget? widget, int localIndex);
...
class ReorderableSliverChildBuilderDelegate extends SliverChildBuilderDelegate
  ...
  IsReorderableCallback? canReorder;
...
//    Widget child = super.build(context, index);
    ...
    if (canReorder != null && !canReorder!(child, index)) {
      return child;
    }
